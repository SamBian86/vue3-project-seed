    ...
    <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
      <PgTable :table-method="getPageHandle" :table-params="tableParams" ref="pgTable">
        ...
        <template v-slot:button>
          <el-row :gutter="StyleEnum.ROW_GUTTER">
            <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
              <el-button
                type="primary"
                v-if="filterPermission('sys:vod:view')"
              ...
              <el-button
                type="primary"
                v-if="filterPermission('sys:vod:save')"
                :size="StyleEnum.BUTTON_SIZE"
        ...
        <template v-slot:content>
          <el-table-column prop="title" :show-overflow-tooltip="true" :label="$t('SysVod.title')"></el-table-column>
          <el-table-column
            prop="uploadDate"
          ...
          <el-table-column :show-overflow-tooltip="true" :label="$t('table.handle')" width="120">
            <template #default="scope">
              ...
              <el-button
                type="text"
                v-if="filterPermission('sys:vod:update')"
                :size="StyleEnum.BUTTON_SIZE"
              ...
              <el-button
                type="text"
                v-if="filterPermission('sys:vod:delete')"
                :size="StyleEnum.BUTTON_SIZE"
...
// 表单页面
import SysVodForm from './form.vue'
export default defineComponent({
  name: 'SysVod', // 模板修改标记
  mixins: [tableMixin],
  components: { PgTable, SkeletonPage, DialogPage, SysVodForm }, // 模板修改标记
  computed: {
  ...
  setup(props) {
    ...
    // API相关
    const { getPageHandle, deleteSysVodVideoByIdHandle } = useSysVodRepository() // 模板修改标记
    ...
    function deleteHandle(params: any) {
      deleteSysVodVideoByIdHandle(params, () => {
        // 模板修改标记
