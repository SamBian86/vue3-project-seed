      ...
      <PgTable :table-method="getPageHandle" :table-params="tableParams" ref="pgTable">
              ...
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="keyword">
                  <el-input
                    ...
                    :placeholder="$t('SysFeedback.keywordPlaceHolder')"
                    clearable
                  ></el-input>
                </el-form-item>
              </el-col>
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="feedbackStatus">
                  <el-select
                    ...
                    v-model="tableParams.feedbackStatus"
                    :placeholder="$t('SysFeedback.feedbackStatusPlaceHolder')"
                    filterable
                    clearable
                  >
                    <el-option
                      v-for="item in getDictByType('feedbackStatus')"
                      :key="item.dictValue"
        ...
        <template v-slot:button>
          <el-row :gutter="StyleEnum.ROW_GUTTER">
            <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
              <el-button
                type="primary"
                v-if="filterPermission('sys:feedback:view')"
              ...
              <!-- <el-button
                type="primary"
                v-if="filterPermission('sys:feedback:save')"
                :size="StyleEnum.BUTTON_SIZE"
        ...
        <template v-slot:content>
          <el-table-column
            ...
            :label="$t('SysFeedback.feedbackNo')"
            width="160"
          ></el-table-column>
          <el-table-column
            prop="feedbackContent"
            :show-overflow-tooltip="true"
            :label="$t('SysFeedback.feedbackContent')"
            width="180"
          ></el-table-column>
          <el-table-column
            prop="feedbackDate"
            :show-overflow-tooltip="true"
            :label="$t('SysFeedback.feedbackDate')"
            width="160"
          ></el-table-column>
          <el-table-column
            prop="feedbackFromName"
            :show-overflow-tooltip="true"
            :label="$t('SysFeedback.feedbackFromName')"
            width="100"
          ></el-table-column>
          <el-table-column
            prop="feedbackUserName"
            :show-overflow-tooltip="true"
            :label="$t('SysFeedback.feedbackUserName')"
            width="120"
          ></el-table-column>
          <el-table-column
            prop="feedbackStatusName"
            :show-overflow-tooltip="true"
            :label="$t('SysFeedback.feedbackStatusName')"
            width="100"
          ></el-table-column>
          <el-table-column
            prop="feedbackHandleTime"
            :show-overflow-tooltip="true"
            :label="$t('SysFeedback.feedbackHandleTime')"
            width="160"
          ></el-table-column>
          <el-table-column
            prop="feedbackRemarks"
            :show-overflow-tooltip="true"
            :label="$t('SysFeedback.feedbackRemarks')"
            min-width="200"
          ></el-table-column>
          ...
          <el-table-column :show-overflow-tooltip="true" :label="$t('table.handle')" width="100">
            <template #default="scope">
              ...
              <el-button
                type="text"
                v-if="filterPermission('sys:feedback:deal') && scope.row.feedbackStatus === 0"
                :size="StyleEnum.BUTTON_SIZE"
              ...
              <!-- <el-button
                type="text"
                v-if="filterPermission('sys:feedback:update')"
                :size="StyleEnum.BUTTON_SIZE"
              ...
              <el-button
                type="text"
                v-if="filterPermission('sys:feedback:delete')"
                :size="StyleEnum.BUTTON_SIZE"
      ...
      <DialogPage ref="dealDialogPage">
        <template #body>
          <div class="component-skeleton-page">
            <SysFeedbackDeal
              :page-type="'update'"
              :page-params="dealPageParams"
              @hide-dialog="hideDealDialog"
              @update-table="pgTableQuery"
            />
          </div>
        </template>
        <template #title>
          {{ $t('SysFeedback.pageDealTitle') }}
        </template>
      </DialogPage>
    </el-col>
  </el-row>
...
// API封装
import useSysFeedbackRepository from './useSysFeedbackRepository' // 模板修改标记
// mixin
import tableMixin from '/@/mixins/tableMixin'
// 表单页面
import SysFeedbackForm from './form.vue'
import SysFeedbackDeal from './deal.vue'
export default defineComponent({
  name: 'SysFeedback', // 模板修改标记
  mixins: [tableMixin],
  components: { PgTable, SkeletonPage, DialogPage, SysFeedbackForm, SysFeedbackDeal }, // 模板修改标记
  computed: {
  ...
  setup(props) {
    ...
    // API相关
    const { getPageHandle, deleteSysFeedbackByIdHandle } = useSysFeedbackRepository() // 模板修改标记
    ...
    function deleteHandle(params: any) {
      deleteSysFeedbackByIdHandle(params, () => {
        // 模板修改标记
