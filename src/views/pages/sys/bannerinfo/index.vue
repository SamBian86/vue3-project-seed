    ...
    <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
      ...
      >
              ...
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="operationType">
                  <el-select
                    ...
                    v-model="tableParams.operationType"
              ...
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="areaId">
                  <el-select
                    class="el-select-block"
                    :size="StyleEnum.FORM_SIZE"
                    v-model="tableParams.areaId"
                    :placeholder="$t('SysBannerinfo.areaIdPlaceHolder')"
                    clearable
                  >
                    <el-option
                      v-for="item in sysServerareaSelect"
                      :key="item.id"
                      :label="item.value"
                      :value="item.id"
                    ></el-option>
        ...
        <template v-slot:button>
          <el-row :gutter="StyleEnum.ROW_GUTTER">
            <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
              <el-button
                type="primary"
                v-if="filterPermission('sys:bannerinfo:view')"
              ...
              <el-button
                type="primary"
                v-if="filterPermission('sys:bannerinfo:save')"
                :size="StyleEnum.BUTTON_SIZE"
        ...
        <template v-slot:content>
          <el-table-column prop="url" :show-overflow-tooltip="true" :label="$t('SysBannerinfo.url')">
          ...
          <el-table-column
            ...
            :label="$t('SysBannerinfo.operationTypeName')"
            width="100"
          ></el-table-column>
          <el-table-column
            prop="createDate"
            :show-overflow-tooltip="true"
            :label="$t('SysBannerinfo.createDate')"
            width="160"
          ></el-table-column>
          <el-table-column prop="display" :show-overflow-tooltip="true" :label="$t('SysBannerinfo.display')" width="100">
            <template #default="scope">
          ...
          <el-table-column :show-overflow-tooltip="true" :label="$t('table.handle')" width="200">
            <template #default="scope">
              <el-button
                type="text"
                v-if="filterPermission('sys:bannerinfo:update')"
                :size="StyleEnum.BUTTON_SIZE"
              ...
              <el-button
                type="text"
                v-if="filterPermission('sys:bannerinfo:delete')"
                :size="StyleEnum.BUTTON_SIZE"
              ...
              <el-button
                type="text"
                v-if="filterPermission('sys:bannerinfo:exchange:update') && scope.$index !== 0"
                :size="StyleEnum.BUTTON_SIZE"
                @click="
              ...
              <el-button
                type="text"
                v-if="filterPermission('sys:bannerinfo:exchange:update') && scope.$index !== tableUsefulData.len - 1"
                :size="StyleEnum.BUTTON_SIZE"
                @click="
                  exchangeSysBannerinfoHandle(
                    { id: scope.row.id, exchangeId: tableUsefulData.data[scope.$index + 1]['id'] },
              ...
              <el-button
                type="text"
                v-if="filterPermission('sys:bannerinfo:exchange:update')"
                :size="StyleEnum.BUTTON_SIZE"
                @click="
                  displaySysBannerinfoHandle({ id: scope.row.id, isdisplay: scope.row.display === 1 ? 0 : 1 }, () => {
                    pgTableQuery(tableParams)
                  })
                "
              >
...
// 表单页面
import SysBannerinfoForm from './form.vue'
export default defineComponent({
  name: 'SysBannerinfo', // 模板修改标记
  mixins: [tableMixin],
  components: { PgTable, SkeletonPage, DialogPage, SysBannerinfoForm }, // 模板修改标记
  computed: {
  ...
  setup(props) {
    ...
    // API相关
    const { getPageHandle, deleteSysBannerinfoByIdHandle, displaySysBannerinfoHandle, exchangeSysBannerinfoHandle } =
    ...
    function deleteHandle(params: any) {
      deleteSysBannerinfoByIdHandle(params, () => {
        // 模板修改标记
        pgTableQuery(tableParams)
      })
    }
