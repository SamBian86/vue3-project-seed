    ...
    <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
      <PgTable :table-method="getPageHandle" :table-params="tableParams" ref="pgTable">
              ...
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="name">
                  <el-input
                    ...
                    :placeholder="$t('SysRole.namePlaceHolder')"
                    clearable
                  ></el-input>
                </el-form-item>
              </el-col>
        ...
        <template v-slot:content>
          <el-table-column prop="name" :show-overflow-tooltip="true" :label="$t('SysRole.name')" width="240"></el-table-column>
          <el-table-column
            prop="deptName"
            :show-overflow-tooltip="true"
            :label="$t('SysRole.deptName')"
            width="300"
          ></el-table-column>
          <el-table-column prop="remark" :show-overflow-tooltip="true" :label="$t('SysRole.remark')"></el-table-column>
          <el-table-column
            prop="createDate"
            :show-overflow-tooltip="true"
            :label="$t('SysRole.createDate')"
            width="160"
          ></el-table-column>
...
export default defineComponent({
  name: 'SysRole', // 模板修改标记
  mixins: [tableMixin],
  components: { PgTable, SkeletonPage, DialogPage, SysRoleForm }, // 模板修改标记
  computed: {
  ...
  setup(props) {
    ...
    // API相关
    const { getPageHandle, deleteSysRoleByIdHandle } = useSysRoleRepository() // 模板修改标记
    ...
    function deleteHandle(params: any) {
      deleteSysRoleByIdHandle(params, () => {
        // 模板修改标记
