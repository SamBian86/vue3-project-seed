  ...
  <el-row :gutter="StyleEnum.ROW_GUTTER">
      ...
      <PgTable :table-method="getPageHandle" :table-params="tableParams" ref="pgTable">
              ...
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="name">
                  <el-input
                    ...
                    :placeholder="$t('VolunteerExchangeproduct.namePlaceHolder')"
                    clearable
                  ></el-input>
                </el-form-item>
              </el-col>
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="isDisplay">
                  <el-select
                    ...
                    :placeholder="$t('VolunteerExchangeproduct.isDisplayPlaceHolder')"
                    filterable
                    clearable
                  >
                    <el-option
        ...
        <template v-slot:button>
          <el-row :gutter="StyleEnum.ROW_GUTTER">
            <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
              <el-button
                type="primary"
                v-if="filterPermission('volunteer:exchangeproduct:view')"
              ...
              <el-button
                type="primary"
                v-if="filterPermission('volunteer:exchangeproduct:save')"
                :size="StyleEnum.BUTTON_SIZE"
        ...
        <template v-slot:content>
          <el-table-column
            ...
            :label="$t('VolunteerExchangeproduct.name')"
            min-width="200"
          ></el-table-column>
          <el-table-column
            prop="credit"
            :show-overflow-tooltip="true"
            :label="$t('VolunteerExchangeproduct.credit')"
            width="100"
          ></el-table-column>
          <el-table-column
            prop="stockQuantity"
            :show-overflow-tooltip="true"
            :label="$t('VolunteerExchangeproduct.stockQuantity')"
            width="100"
          ></el-table-column>
          <el-table-column
            prop="createDate"
            :show-overflow-tooltip="true"
            :label="$t('VolunteerExchangeproduct.createDate')"
            width="160"
          ></el-table-column>
          <el-table-column
            prop="isDisplay"
            :show-overflow-tooltip="true"
            :label="$t('VolunteerExchangeproduct.isDisplay')"
            width="100"
          >
            <template #default="scope">
              <el-tag v-if="scope.row.isDisplay === 0" :size="StyleEnum.TAG_SIZE" type="warning">
                {{ getDictNameByValue('isdisplay', scope.row.isDisplay) }}
              </el-tag>
          ...
          <el-table-column :show-overflow-tooltip="true" :label="$t('table.handle')" width="160">
            <template #default="scope">
              <el-button
                type="text"
                v-if="filterPermission('volunteer:exchangeproduct:update')"
                :size="StyleEnum.BUTTON_SIZE"
              ...
              <el-button
                type="text"
                v-if="filterPermission('volunteer:exchangeproduct:delete')"
                :size="StyleEnum.BUTTON_SIZE"
              ...
              <el-button
                type="text"
                v-if="filterPermission('volunteer:exchangeproduct:display')"
                :size="StyleEnum.BUTTON_SIZE"
                @click="
                  displayVolunteerExchangeproductHandle(
                    { id: scope.row.id, isdisplay: scope.row.isDisplay === 1 ? 0 : 1 },
                    () => {
    ...
    <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
      <DialogPage ref="dialogPage">
        ...
        <template #title>
          {{ $t('VolunteerExchangeproduct.pageTitle') }}
        </template>
      </DialogPage>
    </el-col>
  </el-row>
...
// 表单页面
import VolunteerExchangeproductForm from './form.vue'
export default defineComponent({
  name: 'VolunteerExchangeproduct', // 模板修改标记
  mixins: [tableMixin],
  components: { PgTable, SkeletonPage, DialogPage, VolunteerExchangeproductForm }, // 模板修改标记
  computed: {
  ...
  setup(props) {
    ...
    // API相关
    const { getPageHandle, deleteVolunteerExchangeproductByIdHandle, displayVolunteerExchangeproductHandle } =
    ...
    function deleteHandle(params: any) {
      deleteVolunteerExchangeproductByIdHandle(params, () => {
        // 模板修改标记
        pgTableQuery(tableParams)
      })
    }
