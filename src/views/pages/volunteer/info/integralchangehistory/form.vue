  ...
  >
    <el-row :gutter="StyleEnum.ROW_GUTTER">
      <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
        <el-form-item :label="$t('VolunteerIntegralchangehistory.type')" prop="type">
      ...
      <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
        <el-form-item :label="$t('VolunteerIntegralchangehistory.count')" prop="count">
          <el-input
            v-model="formData.count"
            :placeholder="$t('VolunteerIntegralchangehistory.countPlaceHolder')"
            clearable
      ...
      <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
        <el-form-item :label="$t('VolunteerIntegralchangehistory.operateNote')" prop="operateNote">
          <el-input
            type="textarea"
            :rows="10"
            v-model="formData.operateNote"
            :placeholder="$t('VolunteerIntegralchangehistory.operateNotePlaceHolder')"
            clearable
          ></el-input>
        </el-form-item>
      </el-col>
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    // 校验
    const rules = {
      type: [{ required: true, message: t('VolunteerIntegralchangehistory.typePlaceHolder'), trigger: 'change' }], // 模板修改标记
      count: [{ required: true, message: t('VolunteerIntegralchangehistory.countPlaceHolder'), trigger: 'blur' }], // 模板修改标记
      operateNote: [{ required: true, message: t('VolunteerIntegralchangehistory.operateNotePlaceHolder'), trigger: 'blur' }] // 模板修改标记
    }
