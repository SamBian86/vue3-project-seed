<template>
  <el-row :gutter="StyleEnum.ROW_GUTTER">
    <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
      <PgTable :table-method="getVolunteerActivityApplyListHandle" :table-params="tableParams" ref="pgTable">
        ...
        <template v-slot:content>
          <el-table-column
            ...
            :label="$t('VolunteerActivity.name')"
            min-width="200"
          ></el-table-column>
          <el-table-column
            prop="phoneNumber"
            :show-overflow-tooltip="true"
            :label="$t('VolunteerActivity.phoneNumber')"
            width="160"
          ></el-table-column>
          <el-table-column
            prop="applyDate"
            :show-overflow-tooltip="true"
            :label="$t('VolunteerActivity.applyDate')"
            width="160"
          ></el-table-column>
...
export default defineComponent({
  name: 'VolunteerActivityApplyList', // 模板修改标记
  mixins: [tableMixin],
  ...
  setup(props) {
    ...
    // API相关
    const { getVolunteerActivityApplyListHandle } = useVolunteerActivityRepository() // 模板修改标记
    ...
    return {
      ...
      // 查询相关基础数据及方法
      // API
      getVolunteerActivityApplyListHandle // 模板修改标记 获取分页数据
    }
  }
})
</script>
