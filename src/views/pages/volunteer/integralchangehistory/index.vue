  ...
  <el-row :gutter="StyleEnum.ROW_GUTTER">
      ...
      <PgTable :table-method="getPageHandle" :table-params="tableParams" ref="pgTable">
              ...
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="nameOrPhone">
                  <el-input
                    ...
                    :placeholder="$t('VolunteerIntegralchangehistory.nameOrPhonePlaceHolder')"
                    clearable
                  ></el-input>
                </el-form-item>
              </el-col>
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="productName">
                  <el-input
                    ...
                    :placeholder="$t('VolunteerIntegralchangehistory.productNamePlaceHolder')"
                    clearable
                  ></el-input>
                </el-form-item>
              </el-col>
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="exchangeType">
                  <el-select
                    ...
                    :placeholder="$t('VolunteerIntegralchangehistory.exchangeTypePlaceHolder')"
                    filterable
                    clearable
                  >
                    <el-option
                      v-for="item in getDictByType('integralExchangeType')"
                      :key="item.dictValue"
        ...
        <template v-slot:content>
          <el-table-column
            ...
            :label="$t('VolunteerIntegralchangehistory.volunteerName')"
            min-width="160"
          ></el-table-column>
          <el-table-column
            prop="volunteerPhoneNumber"
            :show-overflow-tooltip="true"
            :label="$t('VolunteerIntegralchangehistory.volunteerPhoneNumber')"
            width="160"
          ></el-table-column>
          <el-table-column
            prop="productName"
            :show-overflow-tooltip="true"
            :label="$t('VolunteerIntegralchangehistory.productName')"
            width="200"
          ></el-table-column>
          <el-table-column
            prop="changeCount"
            :show-overflow-tooltip="true"
            :label="$t('VolunteerIntegralchangehistory.changeCount1')"
            width="100"
          ></el-table-column>
          <el-table-column
            prop="exchangeTypeName"
            :show-overflow-tooltip="true"
            :label="$t('VolunteerIntegralchangehistory.exchangeTypeName')"
            width="100"
          ></el-table-column>
          <el-table-column
            prop="createDate"
            :show-overflow-tooltip="true"
            :label="$t('VolunteerIntegralchangehistory.createDate1')"
            width="160"
          ></el-table-column>
    ...
    <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
      <DialogPage ref="dialogPage">
        ...
        <template #title>
          {{ $t('VolunteerIntegralchangehistory.volunteerTitle') }}
        </template>
      </DialogPage>
    </el-col>
  </el-row>
...
export default defineComponent({
  ...
  setup(props) {
    ...
    // API相关
    const { getPageHandle, deleteVolunteerIntegralchangehistoryByIdHandle } = useVolunteerIntegralchangehistoryRepository() // 模板修改标记
