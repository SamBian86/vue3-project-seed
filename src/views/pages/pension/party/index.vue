      ...
      <PgTable :table-method="getPageHandle" :table-params="tableParams" ref="pgTable">
            ...
            <el-row :gutter="StyleEnum.ROW_GUTTER">
              ...
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="articleType">
                  ...
                  >
                    <el-option
                      v-for="item in getDictByType('partyBuildingType')"
                      :key="item.dictValue"
              ...
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="articleDisplay">
                  <el-select
                    ...
                    :placeholder="$t('PensionParty.articleDisplayPlaceHolder')"
                    filterable
                    clearable
                  >
                    <el-option
        ...
        <template v-slot:button>
          <el-row :gutter="StyleEnum.ROW_GUTTER">
            <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
              <el-button
                type="primary"
                v-if="filterPermission('pension:party:view')"
              ...
              <el-button
                type="primary"
                v-if="filterPermission('pension:party:save')"
                :size="StyleEnum.BUTTON_SIZE"
        ...
        <template v-slot:content>
          <el-table-column
            ...
            :label="$t('PensionParty.articleTitle')"
            min-width="200"
          ></el-table-column>
          <el-table-column
            prop="articleTypeName"
            :show-overflow-tooltip="true"
            :label="$t('PensionParty.articleTypeName')"
            width="120"
          ></el-table-column>
          <el-table-column
            prop="zans"
            :show-overflow-tooltip="true"
            :label="$t('PensionParty.zans')"
            width="100"
          ></el-table-column>
          <el-table-column
            prop="hits"
            :show-overflow-tooltip="true"
            :label="$t('PensionParty.hits')"
            width="100"
          ></el-table-column>
          <el-table-column
            prop="articleDisplay"
            :show-overflow-tooltip="true"
            :label="$t('PensionParty.articleDisplay')"
            width="100"
          >
          ...
          <el-table-column
            prop="articleDate"
            :show-overflow-tooltip="true"
            :label="$t('PensionParty.articleDate')"
            width="160"
          ></el-table-column>
          <el-table-column :show-overflow-tooltip="true" :label="$t('table.handle')" width="160">
            <template #default="scope">
              ...
              <el-button
                type="text"
                v-if="filterPermission('pension:party:update')"
                :size="StyleEnum.BUTTON_SIZE"
              ...
              <el-button
                type="text"
                v-if="filterPermission('pension:party:delete')"
                :size="StyleEnum.BUTTON_SIZE"
              ...
              <el-button
                type="text"
                v-if="filterPermission('pension:party:display:update')"
                :size="StyleEnum.BUTTON_SIZE"
                @click="
                  displayPensionPartyHandle({ id: scope.row.id, display: scope.row.articleDisplay === 1 ? 0 : 1 }, () => {
...
// 表单页面
import PensionPartyForm from './form.vue'
export default defineComponent({
  name: 'PensionParty', // 模板修改标记
  mixins: [tableMixin],
  components: { PgTable, SkeletonPage, DialogPage, PensionPartyForm }, // 模板修改标记
  computed: {
  ...
  setup(props) {
    ...
    // API相关
    const { getPageHandle, deletePensionPartyByIdHandle, displayPensionPartyHandle } = usePensionPartyRepository() // 模板修改标记
    ...
    function deleteHandle(params: any) {
      deletePensionPartyByIdHandle(params, () => {
        // 模板修改标记
        pgTableQuery(tableParams)
      })
    }
