    ...
    <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
      <PgTable :table-method="getPageHandle" :table-params="tableParams" ref="pgTable">
          ...
          <el-form ref="searchForm" :model="tableParams" label-position="left" @keydown.enter.native="pgTableQuery(tableParams)">
            <el-row :gutter="StyleEnum.ROW_GUTTER">
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="governmentTitle">
                  <el-input
                    :size="StyleEnum.INPUT_SIZE"
                    v-model="tableParams.governmentTitle"
              ...
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="governmentType">
                  <el-select
                    class="el-select-block"
                    :size="StyleEnum.FORM_SIZE"
                    v-model="tableParams.governmentType"
                    :placeholder="$t('PensionGovernment.governmentType')"
                    filterable
                    clearable
                  >
                    <el-option
        ...
        <template v-slot:button>
          <el-row :gutter="StyleEnum.ROW_GUTTER">
            <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
              <el-button
                type="primary"
                v-if="filterPermission('pension:government:view')"
              ...
              <el-button
                type="primary"
                v-if="filterPermission('pension:government:save')"
                :size="StyleEnum.BUTTON_SIZE"
        ...
        <template v-slot:content>
          <el-table-column
            prop="governmentTitle"
            :show-overflow-tooltip="true"
            :label="$t('PensionGovernment.governmentTitle')"
            min-width="250"
          ></el-table-column>
          <el-table-column
            prop="governmentTypeName"
            :show-overflow-tooltip="true"
            :label="$t('PensionGovernment.governmentTypeName')"
            width="120"
          ></el-table-column>
          <el-table-column
            prop="governmentEditor"
            :show-overflow-tooltip="true"
            :label="$t('PensionGovernment.governmentEditor')"
            width="100"
          ></el-table-column>
          <el-table-column
            prop="governmentIntroduce"
            :show-overflow-tooltip="true"
            :label="$t('PensionGovernment.governmentIntroduce')"
            width="200"
          ></el-table-column>
          <el-table-column
            prop="governmentDisplay"
            :show-overflow-tooltip="true"
            :label="$t('PensionGovernment.governmentDisplay')"
            width="100"
          >
          ...
          <el-table-column
            prop="createDate"
            :show-overflow-tooltip="true"
            :label="$t('PensionGovernment.createDate')"
            width="160"
          ></el-table-column>
          ...
          <el-table-column :show-overflow-tooltip="true" :label="$t('table.handle')" width="220">
            <template #default="scope">
              ...
              <el-button
                ...
                :size="StyleEnum.BUTTON_SIZE"
                @click="
                  displayPensionGovernmentHandle({ id: scope.row.id, display: scope.row.governmentDisplay === 1 ? 0 : 1 }, () => {
              ...
              <el-button
                type="text"
                v-if="filterPermission('pension:government:update')"
                :size="StyleEnum.BUTTON_SIZE"
              ...
              <el-button
                type="text"
                v-if="filterPermission('pension:government:delete')"
                :size="StyleEnum.BUTTON_SIZE"
...
// 表单页面
import PensionGovernmentForm from './form.vue'
export default defineComponent({
  name: 'PensionGovernment', // 模板修改标记
  mixins: [tableMixin],
  components: { PgTable, SkeletonPage, DialogPage, PensionGovernmentForm }, // 模板修改标记
  computed: {
  ...
  setup(props) {
    ...
    // API相关
    const { getPageHandle, deletePensionGovernmentByIdHandle, displayPensionGovernmentHandle } = usePensionGovernmentRepository() // 模板修改标记
    ...
    function deleteHandle(params: any) {
      deletePensionGovernmentByIdHandle(params, () => {
        // 模板修改标记
        pgTableQuery(tableParams)
      })
    }
