      ...
      <PgTable :table-method="getPageHandle" :table-params="tableParams" ref="pgTable">
              ...
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="visitorName">
                  <el-input
                    ...
                    :placeholder="$t('PensionVisitorScanRecord.visitorNamePlaceHolder')"
                    clearable
                  ></el-input>
                </el-form-item>
              </el-col>
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="scanerName">
                  <el-input
                    :size="StyleEnum.INPUT_SIZE"
                    v-model="tableParams.scanerName"
                    :placeholder="$t('PensionVisitorScanRecord.scanerNamePlaceHolder')"
                    clearable
                  ></el-input>
                </el-form-item>
              </el-col>
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="communityId">
                  <el-select
                    ...
                    :placeholder="$t('PensionVisitorScanRecord.communityIdPlaceHolder')"
                    filterable
                    clearable
                  >
                    <el-option
        ...
        <template v-slot:button>
          <el-row :gutter="StyleEnum.ROW_GUTTER">
            <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
              <el-button
                type="primary"
                v-if="filterPermission('pension:visitorscanrecord:view')"
        ...
        <template v-slot:content>
          <el-table-column
            ...
            :label="$t('PensionVisitorScanRecord.visitorName')"
            width="160"
          ></el-table-column>
          <el-table-column
            prop="visitorSexName"
            :show-overflow-tooltip="true"
            :label="$t('PensionVisitorScanRecord.visitorSexName')"
            width="100"
          ></el-table-column>
          <el-table-column
            prop="communityName"
            :show-overflow-tooltip="true"
            :label="$t('PensionVisitorScanRecord.communityName')"
            min-width="220"
          ></el-table-column>
          <el-table-column
            prop="visitorNum"
            :show-overflow-tooltip="true"
            :label="$t('PensionVisitorScanRecord.visitorNum')"
            width="120"
          ></el-table-column>
          <el-table-column
            prop="scanerName"
            :show-overflow-tooltip="true"
            :label="$t('PensionVisitorScanRecord.scanerName')"
            width="160"
          ></el-table-column>
          <el-table-column
            prop="scanDate"
            :show-overflow-tooltip="true"
            :label="$t('PensionVisitorScanRecord.scanDate')"
            width="160"
          ></el-table-column>
          ...
          <!-- <el-table-column :show-overflow-tooltip="true" :label="$t('table.handle')" width="60">
            <template #default="scope">
              <el-button
                type="text"
                v-if="filterPermission('pension:visitorscanrecord:update')"
                :size="StyleEnum.BUTTON_SIZE"
              ...
              <el-button
                type="text"
                v-if="filterPermission('pension:visitorscanrecord:delete')"
                :size="StyleEnum.BUTTON_SIZE"
...
// API封装
import usePensionVisitorScanRecordRepository from './usePensionVisitorScanRecordRepository' // 模板修改标记
...
export default defineComponent({
  name: 'PensionVisitorScanRecord', // 模板修改标记
  mixins: [tableMixin],
  ...
  setup(props) {
    ...
    // API相关
    const { getPageHandle } = usePensionVisitorScanRecordRepository() // 模板修改标记
