  ...
  <el-row :gutter="StyleEnum.ROW_GUTTER">
      ...
      <PgTable :table-method="getPageHandle" :table-params="tableParams" ref="pgTable">
              ...
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="nameOrPhone">
                  <el-input
                    ...
                    :placeholder="$t('PensionResident.nameOrPhonePlaceHolder')"
                    clearable
                  ></el-input>
                </el-form-item>
              </el-col>
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="relationShip">
                  <el-select
                    class="el-select-block"
                    :size="StyleEnum.FORM_SIZE"
                    v-model="tableParams.relationShip"
        ...
        <template v-slot:button>
          <el-row :gutter="StyleEnum.ROW_GUTTER">
            <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
              <el-button
                type="primary"
                v-if="filterPermission('pension:resident:view')"
              ...
              <el-button
                type="primary"
                v-if="filterPermission('pension:resident:save')"
                :size="StyleEnum.BUTTON_SIZE"
        ...
        <template v-slot:content>
          ...
          <el-table-column
            prop="roomNumber"
            :show-overflow-tooltip="true"
            :label="$t('PensionResident.roomNumber')"
            width="100"
          ></el-table-column>
          <el-table-column
            prop="name"
            :show-overflow-tooltip="true"
            :label="$t('PensionResident.name')"
            width="100"
          ></el-table-column>
          <el-table-column
            prop="sexName"
            :show-overflow-tooltip="true"
            :label="$t('PensionResident.sexName')"
            width="100"
          ></el-table-column>
          <el-table-column
            prop="phoneNumber"
            :show-overflow-tooltip="true"
            :label="$t('PensionResident.phoneNumber')"
            width="140"
          ></el-table-column>
          <el-table-column
            prop="houseTypeName"
    ...
    <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
      <DialogPage ref="dialogPage">
        ...
        <template #title>
          {{ $t('PensionResident.ylresidentTitle') }}
        </template>
      </DialogPage>
    </el-col>
  </el-row>
...
// 表单页面
import PensionResidentForm from './form.vue'
export default defineComponent({
  ...
  setup(props) {
    ...
    function deleteHandle(params: any) {
      deletePensionResidentByIdHandle(params, () => {
        // 模板修改标记
