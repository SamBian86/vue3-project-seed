  ...
  <el-row :gutter="StyleEnum.ROW_GUTTER">
      ...
      <PgTable :table-method="getPageHandle" :table-params="tableParams" ref="pgTable">
        <template v-slot:search>
          <el-form ref="searchForm" :model="tableParams" label-position="left" @keydown.enter.native="pgTableQuery(tableParams)">
            <el-row :gutter="StyleEnum.ROW_GUTTER">
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="visitor">
                  <el-input
                    ...
                    v-model="tableParams.visitor"
                    :placeholder="$t('PensionVisitrecord.visitorPlaceHolder')"
                    clearable
                  ></el-input>
                </el-form-item>
              </el-col>
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="importantPerson">
                  <el-input
                    :size="StyleEnum.INPUT_SIZE"
                    v-model="tableParams.importantPerson"
              ...
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="escort">
                  <el-input
                    :size="StyleEnum.INPUT_SIZE"
                    v-model="tableParams.escort"
                    :placeholder="$t('PensionVisitrecord.escortPlaceHolder')"
                    clearable
                  ></el-input>
                </el-form-item>
              </el-col>
        ...
        <template v-slot:button>
          <el-row :gutter="StyleEnum.ROW_GUTTER">
            <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
              <el-button
                type="primary"
                v-if="filterPermission('pension:visitrecord:view')"
              ...
              <el-button
                type="primary"
                v-if="filterPermission('pension:visitrecord:save')"
                :size="StyleEnum.BUTTON_SIZE"
        ...
        <template v-slot:content>
          <el-table-column
            ...
            :label="$t('PensionVisitrecord.visitor')"
            width="160"
          ></el-table-column>
          <el-table-column
            prop="visitorNum"
            :show-overflow-tooltip="true"
            :label="$t('PensionVisitrecord.visitorNum')"
            width="80"
          ></el-table-column>
          <el-table-column prop="visitDate" :show-overflow-tooltip="true" :label="$t('PensionVisitrecord.visitDate')">
            <template #default="scope">
              <div>{{ scope.row.visitDateFrom }} - {{ scope.row.visitDateTo }}</div>
            </template>
          </el-table-column>
          <el-table-column
            prop="importantPerson"
            :show-overflow-tooltip="true"
            :label="$t('PensionVisitrecord.importantPerson')"
            width="160"
          ></el-table-column>
          <el-table-column
            prop="escort"
            :show-overflow-tooltip="true"
            :label="$t('PensionVisitrecord.escort')"
            width="160"
          ></el-table-column>
          ...
          <el-table-column :show-overflow-tooltip="true" :label="$t('table.handle')" width="160">
            <template #default="scope">
              ...
              <el-button
                type="text"
                v-if="filterPermission('pension:visitrecord:update')"
                :size="StyleEnum.BUTTON_SIZE"
              ...
              <el-button
                type="text"
                v-if="filterPermission('pension:visitrecord:delete')"
                :size="StyleEnum.BUTTON_SIZE"
    ...
    <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
      <DialogPage ref="dialogPage">
        ...
        <template #title>
          {{ $t('PensionVisitrecord.pageTitle') }}
        </template>
      </DialogPage>
    </el-col>
  </el-row>
...
// 表单页面
import PensionVisitrecordForm from './form.vue'
export default defineComponent({
  name: 'PensionVisitrecord', // 模板修改标记
  mixins: [tableMixin],
  components: { PgTable, SkeletonPage, DialogPage, PensionVisitrecordForm }, // 模板修改标记
  computed: {
  ...
  setup(props) {
    ...
    // API相关
    const { getPageHandle, deletePensionVisitrecordByIdHandle } = usePensionVisitrecordRepository() // 模板修改标记
    ...
    function deleteHandle(params: any) {
      deletePensionVisitrecordByIdHandle(params, () => {
        // 模板修改标记
