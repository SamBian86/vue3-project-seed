<template>
  <el-row :gutter="StyleEnum.ROW_GUTTER">
      ...
      <PgTable :table-method="getPageHandle" :table-params="tableParams" ref="pgTable">
              ...
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="nameOrPhone">
                  <el-input
                    ...
                    :placeholder="$t('PensionMaintenanceworker.nameOrPhonePlaceHolder')"
                    clearable
                  ></el-input>
                </el-form-item>
              </el-col>
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="positionId">
                  <el-select
                    ...
                    :placeholder="$t('PensionMaintenanceworker.positionIdPlaceHolder')"
                    filterable
                    clearable
                  >
                    <el-option
                      v-for="item in getDictByType('maintenancePosition')"
                      :key="item.dictValue"
              ...
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="communityId">
                  <el-select
                    ...
                    :placeholder="$t('PensionMaintenanceworker.communityIdPlaceHolder')"
                    filterable
                    clearable
                  >
                    <el-option
              ...
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="deptId">
                  <el-cascader
                    ...
                    :options="sysDeptTree"
                    :props="cascaderProps"
                    :placeholder="$t('PensionMaintenanceworker.deptIdPlaceHolder')"
                  ></el-cascader>
                </el-form-item>
              </el-col>
            </el-row>
        ...
        <template v-slot:button>
          <el-row :gutter="StyleEnum.ROW_GUTTER">
            <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
              <el-button
                type="primary"
                v-if="filterPermission('pension:maintenanceworker:view')"
              ...
              <el-button
                type="primary"
                v-if="filterPermission('pension:maintenanceworker:save')"
                :size="StyleEnum.BUTTON_SIZE"
        ...
        <template v-slot:content>
          <el-table-column
            ...
            :label="$t('PensionMaintenanceworker.name')"
            width="160"
          ></el-table-column>
          <el-table-column
            prop="sexName"
            :show-overflow-tooltip="true"
            :label="$t('PensionMaintenanceworker.sexName')"
            width="80"
          ></el-table-column>
          <el-table-column
            prop="phoneNumber"
            :show-overflow-tooltip="true"
            :label="$t('PensionMaintenanceworker.phoneNumber')"
            width="160"
          ></el-table-column>
          <el-table-column
            prop="positionName"
            :show-overflow-tooltip="true"
            :label="$t('PensionMaintenanceworker.positionName')"
            width="120"
          ></el-table-column>
          <el-table-column
            prop="communityName"
            :show-overflow-tooltip="true"
            :label="$t('PensionMaintenanceworker.communityName')"
          ></el-table-column>
          <el-table-column
            prop="deptName"
            :show-overflow-tooltip="true"
            :label="$t('PensionMaintenanceworker.deptName')"
            width="360"
          ></el-table-column>
          ...
          <el-table-column :show-overflow-tooltip="true" :label="$t('table.handle')" width="120">
            <template #default="scope">
              ...
              <el-button
                type="text"
                v-if="filterPermission('pension:maintenanceworker:update')"
                :size="StyleEnum.BUTTON_SIZE"
              ...
              <el-button
                type="text"
                v-if="filterPermission('pension:maintenanceworker:delete')"
                :size="StyleEnum.BUTTON_SIZE"
    ...
    <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
      <DialogPage ref="dialogPage">
        ...
        <template #title>
          {{ $t('PensionMaintenanceworker.pageTitle') }}
        </template>
      </DialogPage>
    </el-col>
  </el-row>
  <DialogPage ref="dialogEmployeeDetailPage">
    ...
    <template #title>
      {{ $t('PensionMaintenanceworker.employeeDetail') }}
    </template>
  </DialogPage>
</template>
<script lang='ts'>
...
// 表单页面
import PensionMaintenanceworkerForm from './form.vue'
import PensionEmployeeForm from '../employee/form.vue'
export default defineComponent({
  name: 'PensionMaintenanceworker', // 模板修改标记
  mixins: [tableMixin],
  components: { PgTable, SkeletonPage, DialogPage, PensionMaintenanceworkerForm, PensionEmployeeForm }, // 模板修改标记
  computed: {
  ...
  setup(props) {
    ...
    function deleteHandle(params: any) {
      deletePensionMaintenanceworkerByIdHandle(params, () => {
        // 模板修改标记
