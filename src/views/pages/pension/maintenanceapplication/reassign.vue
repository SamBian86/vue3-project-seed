...
export default defineComponent({
  name: 'PensionMaintenanceapplicationReassign', // 模板修改标记
  mixins: [formMixin],
  components: {},
  computed: {
  ...
  setup(props, { emit }) {
    const { t } = useI18n()
    const { formData, reAssignPensionMaintenanceapplicationByIdHandle } = usePensionMaintenanceapplicationRepository() // 模板修改标记
    ...
    function submitHandle() {
      const cMethod = reAssignPensionMaintenanceapplicationByIdHandle // 模板修改标记
