<template>
  <el-row :gutter="StyleEnum.ROW_GUTTER">
    <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
      <PgTable :table-method="getHouseReplacementinfoCommunitiesPageHandle" :table-params="tableParams" ref="pgTable">
              ...
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="communityName">
                  <el-input
                    ...
                    :placeholder="$t('HouseReplacementinfo.communityName')"
                    clearable
                  ></el-input>
                </el-form-item>
              </el-col>
        ...
        <template v-slot:content>
          ...
          <el-table-column
            prop="areaName"
            :show-overflow-tooltip="true"
            :label="$t('HouseReplacementinfo.areaName')"
          ></el-table-column>
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    // API相关
    const { getHouseReplacementinfoCommunitiesPageHandle, boundHouseReplacementinfoByIdHandle } =
    ...
    function boundHandle(item: any) {
      item.id = props.pageParams.id
      boundHouseReplacementinfoByIdHandle(item, () => {
    ...
    return {
      ...
      // 查询相关基础数据及方法
      // API
      getHouseReplacementinfoCommunitiesPageHandle, // 模板修改标记 获取分页数据
      boundHandle
    }
  }
})
