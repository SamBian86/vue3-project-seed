    ...
    <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
      <PgTable :table-method="getPageHandle" :table-params="tableParams" ref="pgTable">
              ...
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop='name'>
                  <el-input
                    ...
                    :placeholder='$t("CustomerWm.namePlaceHolder")'
                    clearable
                  ></el-input>
                </el-form-item>
              </el-col>
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop='phone'>
                  <el-input
                    ...
                    :placeholder='$t("CustomerWm.phonePlaceHolder")'
                    clearable
                  ></el-input>
                </el-form-item>
              </el-col>
        ...
        <template v-slot:button>
          <el-row :gutter="StyleEnum.ROW_GUTTER">
            <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
              <el-button
                type="primary"
                v-if="filterPermission('customer:wm:view')"
        ...
        <template v-slot:content>
          <el-table-column prop='wid' :show-overflow-tooltip='true' :label='$t("CustomerWm.wid")' width='200'></el-table-column>
          <el-table-column prop='name' :show-overflow-tooltip='true' :label='$t("CustomerWm.name")' width='100'></el-table-column>
          <el-table-column prop='phone' :show-overflow-tooltip='true' :label='$t("CustomerWm.phone")' width='200'></el-table-column>
          <el-table-column prop='birthday' :show-overflow-tooltip='true' :label='$t("CustomerWm.birthday")'></el-table-column>
          
          <!-- <el-table-column :show-overflow-tooltip="true" :label="$t('table.handle')" width="60">
            <template #default="scope"> -->
              <!-- <el-button
                type="text"
                v-if="filterPermission('customer:wm:update')"
                :size="StyleEnum.BUTTON_SIZE"
              ...
              <el-button
                type="text"
                v-if="filterPermission('customer:wm:delete')"
                :size="StyleEnum.BUTTON_SIZE"
...
// API封装
import useCustomerWmRepository from './useCustomerWmRepository' // 模板修改标记
// mixin
import tableMixin from '/@/mixins/tableMixin'
// 页面

export default defineComponent({
  name: 'CustomerWm', // 模板修改标记
  mixins: [tableMixin],
  ...
  setup(props) {
    ...
    // API相关
    const { getPageHandle } = useCustomerWmRepository() // 模板修改标记
