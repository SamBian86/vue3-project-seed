<template>
  <el-row :gutter="StyleEnum.ROW_GUTTER">
    <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
      <PgTable :table-method="callCardOperationinfoByInterfaceNameHandle" :table-params="tableParams" ref="pgTable">
        ...
        <template v-slot:content>
          <el-table-column
            ...
            :label="$t('CardInfo.addTimeRecharge')"
            width="200"
          ></el-table-column>
          <el-table-column
            prop="storeName"
            :show-overflow-tooltip="true"
            :label="$t('CardInfo.storeNameRecharge')"
            min-width="200"
          ></el-table-column>
          <el-table-column
            prop="hisMoney"
            :show-overflow-tooltip="true"
            :label="$t('CardInfo.hisMoneyRecharge')"
            width="200"
          ></el-table-column>
...
export default defineComponent({
  name: 'CardInfoRechargeList', // 模板修改标记
  mixins: [tableMixin],
  ...
  setup(props) {
    ...
    const tableParams = reactive({
      // 模板修改标记
      interfaceName: 'queryRechargeInfo',
      cardId: props.pageParams.id
    })
    ...
    return {
      ...
      // 查询相关基础数据及方法
      // API
      callCardOperationinfoByInterfaceNameHandle // 模板修改标记 获取分页数据
    }
  }
})
</script>
