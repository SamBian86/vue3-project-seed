  ...
  <el-row :gutter="StyleEnum.ROW_GUTTER">
      ...
      <PgTable :table-method="getPageHandle" :table-params="tableParams" ref="pgTable">
              ...
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="mobile">
                  <el-input
                    ...
                    :placeholder="$t('CardRechargerecord.mobilePlaceHolder')"
                    clearable
                  ></el-input>
                </el-form-item>
              </el-col>
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="status">
                  <el-select
                    ...
                    :placeholder="$t('CardRechargerecord.statusPlaceHolder')"
                    filterable
                    clearable
                  >
                    <el-option
                      v-for="item in getDictByType('onecardRechargeStatus')"
                      :key="item.dictValue"
        ...
        <template v-slot:button>
          <el-row :gutter="StyleEnum.ROW_GUTTER">
            <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
              <el-button
                type="primary"
                v-if="filterPermission('card:rechargerecord:view')"
              ...
              <!-- <el-button
                type="primary"
                v-if="filterPermission('card:rechargerecord:save')"
                :size="StyleEnum.BUTTON_SIZE"
        ...
        <template v-slot:content>
          <el-table-column
            ...
            :label="$t('CardRechargerecord.price')"
            width="160"
          ></el-table-column>
          <el-table-column
            prop="userPhoneNumber"
            :show-overflow-tooltip="true"
            :label="$t('CardRechargerecord.userPhoneNumber')"
            width="160"
          ></el-table-column>
          <el-table-column
            prop="cardNo"
            :show-overflow-tooltip="true"
            :label="$t('CardRechargerecord.cardNo')"
            min-width="200"
          ></el-table-column>
          <el-table-column
            prop="orderNo"
            :show-overflow-tooltip="true"
            :label="$t('CardRechargerecord.orderNo')"
            min-width="240"
          ></el-table-column>
          <el-table-column
            prop="statusName"
            :show-overflow-tooltip="true"
            :label="$t('CardRechargerecord.statusName')"
            width="100"
          >
            <template #default="scope">
              {{ getDictNameByValue('onecardRechargeStatus', scope.row.status) }}
            </template>
          </el-table-column>
          <el-table-column
            prop="createDate"
            :show-overflow-tooltip="true"
            :label="$t('CardRechargerecord.createDate')"
            width="160"
          ></el-table-column>
          ...
          <el-table-column :show-overflow-tooltip="true" :label="$t('table.handle')" width="120">
            <template #default="scope">
              ...
              <!-- <el-button
                type="text"
                v-if="filterPermission('card:rechargerecord:update')"
                :size="StyleEnum.BUTTON_SIZE"
              ...
              <el-button
                type="text"
                v-if="filterPermission('card:rechargerecord:delete')"
                :size="StyleEnum.BUTTON_SIZE"
    ...
    <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="24" :lg="24" :xl="24">
      <DialogPage ref="dialogPage">
        ...
        <template #title>
          {{ $t('CardRechargerecord.pageTitle') }}
        </template>
      </DialogPage>
    </el-col>
  </el-row>
...
// 表单页面
import CardRechargerecordForm from './form.vue'
export default defineComponent({
  name: 'CardRechargerecord', // 模板修改标记
  mixins: [tableMixin],
  components: { PgTable, SkeletonPage, DialogPage, CardRechargerecordForm }, // 模板修改标记
  computed: {
  ...
  setup(props) {
    ...
    // API相关
    const { getPageHandle } = useCardRechargerecordRepository() // 模板修改标记
    ...
    //   deleteCardRechargerecordByIdHandle(params, () => {
    //     // 模板修改标记
