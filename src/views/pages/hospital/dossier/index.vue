      ...
      <PgTable :table-method="getPageHandle" :table-params="tableParams" ref="pgTable">
              ...
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="cardNo">
                  <el-input
                    ...
                    :placeholder="$t('HospitalDossier.cardNoPlaceHolder')"
                    clearable
                  ></el-input>
                </el-form-item>
              </el-col>
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="nameOrPhoneNumber">
                  <el-input
                    :size="StyleEnum.INPUT_SIZE"
                    v-model="tableParams.nameOrPhoneNumber"
                    :placeholder="$t('HospitalDossier.nameOrPhoneNumberPlaceHolder')"
                    clearable
                  ></el-input>
                </el-form-item>
              </el-col>
              <el-col :xs="StyleEnum.COL_XS" :sm="StyleEnum.COL_SM" :md="4" :lg="4" :xl="4">
                <el-form-item prop="sex">
                  <el-select
                    ...
                    :placeholder="$t('HospitalDossier.sexPlaceHolder')"
                    filterable
                    clearable
                  >
                    <el-option
        ...
        <template v-slot:content>
          <el-table-column
            ...
            :label="$t('HospitalDossier.name')"
            min-width="100"
          ></el-table-column>
          <el-table-column
            prop="sexName"
            :show-overflow-tooltip="true"
            :label="$t('HospitalDossier.sexName')"
            width="100"
          ></el-table-column>
          <el-table-column
            prop="phoneNumber"
            :show-overflow-tooltip="true"
            :label="$t('HospitalDossier.phoneNumber')"
            width="160"
          ></el-table-column>
          <el-table-column
            prop="cardNo"
            :show-overflow-tooltip="true"
            :label="$t('HospitalDossier.cardNo')"
            min-width="200"
          ></el-table-column>
          <el-table-column
            prop="birthday"
            :show-overflow-tooltip="true"
            :label="$t('HospitalDossier.birthday')"
            width="180"
          ></el-table-column>
          <el-table-column
            prop="createDate"
            :show-overflow-tooltip="true"
            :label="$t('HospitalDossier.createDate')"
            width="160"
          ></el-table-column>
...
// API封装
import useHospitalDossierRepository from './useHospitalDossierRepository' // 模板修改标记
// mixin
...
export default defineComponent({
  ...
  setup(props) {
    ...
    // API相关
    const { getPageHandle } = useHospitalDossierRepository() // 模板修改标记
